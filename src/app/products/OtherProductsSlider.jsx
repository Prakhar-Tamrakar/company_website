...
export default function OtherProductsSlider({ excludeId }) {
  const sliderRef = useRef(null);

  // Filter out the current product
  const filteredProducts = values.filter((item) => item.id !== excludeId);
  ...
  return (
    <section className="w-full">
      ...
      <div className="mb-6 flex items-center justify-between">
        <h3 className="text-xl font-semibold text-primary">Other Products</h3>
