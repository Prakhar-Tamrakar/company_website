  ...
  return (
    <div id={id} className="mt-10 scroll-mt-20">
      ...
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-12 items-center gap-4 md:gap-0">
        ...
        <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-lg md:col-span-7 md:col-start-1 md:row-start-1 z-0 ">
          <div className="px-6 py-8 md:px-8 md:py-10 h-full w-full">
            <div className="flex md:justify-between h-full">

              {/* Text Content */}
              <div className="flex flex-col justify-start md:w-[80%] lg:w-[72%] gap-4">
                {/* Category label */}
                ...
                {/* Main heading */}
                <h2 className="text-xl md:text-xl lg:text-2xl heading-default font-bold text-primary leading-snug tracking-wide mt-2">
                  {heading}
                </h2>

                {/* Subheading */}
                <p className="text-sm md:text-base text-white/70 content-default leading-relaxed md:w-[90%]">
                  {subheading}
                </p>
              </div>

              {/* Spacer */}
              <div className="hidden md:block md:w-[20%] lg:w-[28%]" />
            </div>
          </div>
        </div>

        {/* 2. CONTENT CARD — Right side on desktop, overlapping */}
        <div className="relative z-10 -mt-3 md:mt-0 md:col-span-7 md:col-start-6 md:row-start-1 lg:col-start-6 lg:col-span-8">
