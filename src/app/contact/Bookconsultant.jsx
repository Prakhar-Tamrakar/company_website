    ...
    <Section className="relative min-h-[70vh] w-full flex items-center justify-center overflow-hidden bg-[#010518]">
      ...
      <div className="relative z-10 max-w-5xl px-6 text-center">
        ...
        <p className="mt-3 text-gray-200 leading-normal text-[16px] sm:text-[17px] md:text-[18px] font-normal tracking-[0.02em]">
          You&apos;re not reaching out to a call center — you&apos;re connecting
          with a real person who understands technology, timelines, and business
          priorities. Let&apos;s start solving, together.
        </p>
        {/* CTA Buttons */}
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href={"/contact#form#form"}
            className="flex items-center gap-2 px-6 py-3 rounded-full bg-white text-[#010518] text-sm font-medium shadow-md hover:bg-gray-100 transition pointer-cursor"
          >
