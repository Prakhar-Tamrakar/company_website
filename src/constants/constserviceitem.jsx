...
export const content3 = [{ id:1, icon:Users, heading:'Large-scale public events', subhead:'Planning for religious, cultural and civic events.' },
         { id:2, icon:Shield, heading:'Safety & Logistics:', subhead:'Delivering IT-enabled crowd management and risk mitigation strategies' }]

export const content4 = [{ id:1, icon:Bot , heading:'AI & Digital Upskilling: ', subhead:'Training youth and professionals in advanced automation and digital tools.' }, 
         { id:2, icon:Rocket    , heading:'Innovation Incubator:', subhead:'A production-grade environment where participants build practical, commercial-ready solutions.' }]

export const content5 = [{ id:1, icon:Server, heading:'Cloud Infrastructure & Provisioning: ', subhead:' Server, storage, and cloud management.' },
         { id:2, icon:RefreshCcw, heading:'Cybersecurity:', subhead:'Assessments, audits, and compliance support to ensure operational continuity.' }]

export const content6 = [{ id:1, icon:UserPlus , heading:'Scale Teams Quickly: ', subhead:'Enabling organizations to quickly scale teams, fill critical skill gaps, and accelerate delivery. ' },
         { id:2, icon:SlidersHorizontal   , heading:'Flexible Engagement: ', subhead:'flexible engagement models aligned to delivery needs, to ensure the right expertise at the right time.' } 
]
